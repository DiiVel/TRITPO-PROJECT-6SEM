...
from models.db.models import OrderModel, OrderItemsModel, ShippingAddressModel
...
class OrderService:
    ...
    def create_order_place(request: OrderCreatePlaceOrder, db: Session):
    ...
    def get_order_by_user_id(userid: int, db: Session):
        order_by_userid = (
